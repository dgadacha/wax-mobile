...
const messages = {
  en: {
    ...
    'album.saving': ({ done, total }) => `Saving… ${done} / ${total}`,
    'album.save_as_playlist_done': ({ name }) => `Created playlist "${name}".`,
  ...
  fr: {
    ...
    'album.saving': ({ done, total }) => `Sauvegarde… ${done} / ${total}`,
    'album.save_as_playlist_done': ({ name }) => `Playlist "${name}" créée.`,
